...
* **Note 2**: Browsers not using hardware based DRM(ie. Mozilla Firefox or Chromium based Browsers like Google Chrome), will have working DRM without any work both on iGPUs and dGPUs. The below guide is for Safari and other applications with hardware based DRM
