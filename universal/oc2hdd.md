...
When you mount your main drive's EFI, you may be greeted with a folder called `APPLE`, which is used for updating the firmware on real Macs but has no effect on our hardware. You can wipe everything on the EFI partition and replace it with the one found on your USB.
