...
The following items will be created below and are needed to use iServices:
...
## Generate a new Serial set

### Option 1: Use https://github.com/sickcodes/osx-serial-generator
...
iMacPro1,1  C02Y8EZGHX87    C02907600J9JG36FB   3F903350-F819-487D-9445-1D6D3B8F80C1    1C:5C:F2:C1:03:BC   1920    1080
```

ROM is calculated from your MAC Address.

Lowercase your MAC Address, and remove each colon `:` between octets.

**MAC:** `1C:5C:F2:C1:03:BC`
...
Reboot your system, and you should be able to log right in!

It is recommended to use the MAC Address generated by https://github.com/sickcodes/osx-serial-generator because it will use MAC Address Block ID that Apple uses.

### Option 2: Use https://github.com/corpnewt/GenSMBIOS
